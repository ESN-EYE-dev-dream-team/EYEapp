...
const _isArray = _interopRequireDefault(require('lodash/isArray'));

const _DefaultLoadErrorComponent = _interopRequireDefault(require('./DefaultLoadErrorComponent'));
...
const withGoogleSheets = function withGoogleSheets() {
            ...
            (_temp = _class = (function(_Component) {
                ...
                function _class() {
                    ...
                    _this = _possibleConstructorReturn(
                        this,
                        (_getPrototypeOf2 = _getPrototypeOf(_class)).call.apply(_getPrototypeOf2, [this].concat(args)),
                    );
                                    ...
                                    dataLoadError: _objectSpread({}, config.dataLoadError || {}, {
                                        title:
                                            config.dataLoadError && config.dataLoadError.title
                                                ...
                                                : 'Data Load Error: HTTP Status: '.concat(error.code),
                                        message:
                                ...
                                if (sheets === '*') {
                                    ...
                                    sheets
                                        ...
                                        .forEach(function(sheet) {
                                            const data = (0, _get['default'])(db, sheet);
...
const _default = withGoogleSheets;
